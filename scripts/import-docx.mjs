...
const ROOT = process.argv[2]; // e.g., "/Users/ryanwhitney/Google Drive/soapsandlabs"
...
async function importOne(file) {
  ...
  // insert into master_tracker (snapshot for board/search)
